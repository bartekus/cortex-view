...
3. **Current State**:
   - The command *runs* and rebuilds the menu, but the actual string translation logic inside `create_tray_menu` is commented out/incomplete ("TODO: tray internationalization").
